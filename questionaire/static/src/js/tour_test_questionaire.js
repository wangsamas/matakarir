odoo.define('questionaire.tour_test_questionaire', function (require) {
'use strict';

var tour = require('web_tour.tour');
var base = require("web_editor.base");

tour.register('test_questionaire', {
    test: true,
    url: '/questionaire/start/user-feedback-form-1/phantom',
    wait_for: base.ready()
},
    [
        // Page-1
        {
            content: "Clicking on Start Questionaire",
            trigger: 'a.btn.btn-primary.btn-lg:contains("Start Questionaire")',
        },
