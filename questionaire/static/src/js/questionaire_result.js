odoo.define('questionaire.result', function (require) {
'use strict';

require('web.dom_ready');

if(!$('.js_questionaireresult').length) {
    return $.Deferred().reject("DOM doesn't contain '.js_questionaireresult'");
}

    console.debug("[questionaire] Questionaire Result JS is loading...");

    //Script For Pagination
    var questionaire_pagination = $('.pagination');
    $.each(questionaire_pagination, function(index, pagination){
    ...
    //load chart to svg element chart:initialized chart, response:AJAX response, quistion_id:if of questionaire question, tick_limit:text length limit
    ...
    //Script For Graph
    var questionaire_graphs = $('.questionaire_graph');
    $.each(questionaire_graphs, function(index, graph){
    ...
    // Script for filter
    $('td.questionaire_answer').hover(function(){
        $(this).find('i.fa-filter').removeClass('invisible');
    }, function(){
        $(this).find('i.fa-filter').addClass('invisible');
    });
    $('td.questionaire_answer i.fa-filter').click(function(){
        var cell = $(this);
    ...
    $('.clear_questionaire_filter').click(function(){
    ...
    // toggle finished/all questionaires filter
    ...
    console.debug("[questionaire] Questionaire Result JS loaded!");
